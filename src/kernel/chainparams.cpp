...
{
    const char* pszTimestamp = "TWOORE Genesis - Independent Blockchain - 2025";
    const CScript genesisOutputScript = CScript() << ParseHex("04fba8c6d27c837edc04b9c13f0d6c5f65a7c0a7f7d34231010680afb316b4c15834babf98a78b9e7a0c85990af04fa417b1fb789ddafa12a7efc5ec15b81dc666") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256(); // 824000
        ...
        genesis = CreateGenesisBlock(1787495334, 915223122, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000490d9f30a1e0734620d6999ad0b6abc9f6b7b5967709544fda9f8d0d"));
        assert(genesis.hashMerkleRoot == uint256S("0xc3d0804395b5fe71f4fc1009f1a390955683c69e9b66e4dd55c6271159f9a350"));
